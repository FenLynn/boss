#ifndef Physics_Analysis_GamPiPiKK_H
#define Physics_Analysis_GamPiPiKK_H 
...
class GamPiPiKK:public Algorithm{

	public:
		GamPiPiKK(const std::string& name, ISvcLocator* pSvcLocator);
